        ...
        <script type="application/ld+json">{`
          {
            ...
            "itemListElement": [
              ...
              { "@type": "ListItem", "position": 2, "name": "About", "item": "https://www.lsat.academy/about" }
            ]
          }
        `}</script>
        <script type="application/ld+json">{`
          {
            ...
            "image": "https://www.lsat.academy/assets/david.png",
            "description": "99th percentile LSAT scorer with 15 years of tutoring experience and the founder of LSAT Academy.",
            "worksFor": { "@id": "https://www.lsat.academy/#organization" },
            "sameAs": [
              "https://www.instagram.com/lsatacademy/",
              "https://www.reddit.com/user/the10000hourtutor/"
            ]
          }
        `}</script>
      </Helmet>
      ...
      <main className="about max padding">
        <section className="about-me">
          ...
          <div className="about-content">
            <Img src="/assets/david.png" alt="David McMaster, LSAT Tutor and founder of LSAT Academy" loading="lazy" decoding="async" width="400" height="400" />
        ...
        <section className="approach-wrap spacer">
          ...
          <div className="approach-content">
            <div className="approach">
              <Img src="/assets/person-icon.png" alt="" aria-hidden="true" loading="lazy" decoding="async" width="48" height="48" />
              <div className="text">
            ...
            <div className="approach">
              <Img src="/assets/brain-icon.png" alt="" aria-hidden="true" loading="lazy" decoding="async" width="48" height="48" />
              <div className="text">
            ...
            <div className="approach">
              <Img src="/assets/strategy-icon.png" alt="" aria-hidden="true" loading="lazy" decoding="async" width="48" height="48" />
              <div className="text">
